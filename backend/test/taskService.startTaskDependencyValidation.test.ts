...
test('startTask passes when all upstream tasks are DONE', async () => {
...
test('startTask throws BusinessError when an upstream task is TODO', async () => {
  const restore = stubStartWorkflow();
...
test('startTask throws BusinessError when an upstream task is IN_PROGRESS', async () => {
  const restore = stubStartWorkflow();
...
test('startTask throws BusinessError when an upstream task is BLOCKED', async () => {
  const restore = stubStartWorkflow();
...
test('startTask throws BusinessError when a depends_on points to a non-existent task', async () => {
  const restore = stubStartWorkflow();
...
test('startTask passes when depends_on is empty (regression)', async () => {
  const restore = stubStartWorkflow();
