...
test.test('resolveWorkflowSkills collects deduplicated agent skills', async () => {
  ...
  try {
    const workflow: WorkflowInstanceEntity = {
      ...
      name: 'Test Instance',
      steps: [
        { id: 'a', name: 'A', instructionPrompt: 'A', agentId: 1, onFailureLoopTo: null },
        { id: 'b', name: 'B', instructionPrompt: 'B', agentId: 2, onFailureLoopTo: null },
      ],
...
test.test('resolveWorkflowSkills returns empty array when workflow has no agents', async () => {
  const workflow: WorkflowInstanceEntity = {
    ...
    name: 'Test Instance',
    steps: [
      { id: 'a', name: 'A', instructionPrompt: 'A', agentId: undefined as unknown as number, onFailureLoopTo: null },
    ],
    created_at: '2026-03-22T00:00:00.000Z',
    updated_at: '2026-03-22T00:00:00.000Z',
  };
