export default {
  ...
  nav: {
    ...
    skills: 'Skill管理',
    mcpServers: 'MCP配置',
    agentKnowledgeBus: 'Agent知识总线',
    settings: '设置',
    groupOperations: '运营 / 管理',
    dashboard: '运营',
    runDashboard: '管理看板',
  },
  dashboard: {
  ...
  taskSource: {
    ...
    syncFrequency: '同步频率',
    scheduleDisabled: '不启用',
    scheduleEvery5m: '每 5 分钟',
    scheduleEvery15m: '每 15 分钟',
    scheduleEvery30m: '每 30 分钟',
    scheduleHourly: '每小时',
  ...
  workflowTemplate: {
    title: 'AgentTeam模板',
    description: 'AgentTeam按照PDMC+的研发活动流程定义，组织各Agent角色完成端到端的研发作业过程，支持选择、创建、编辑和删除模板，并配置每个步骤的Harness工程约束。',
...
只输出 JSON 代码块，不要其他解释。`,
    ...
    unsavedChangesWarning: '当前模板有未保存的更改，切换模板将丢失这些修改。确定要继续吗？',
  ...
  bundle: {
    ...
    next: '下一步',
    back: '上一步',
    confirmDepsHint: '确认要包含的关联资源（取消勾选不需要的依赖）：',
    confirmExport: '确认导出',
    exportSuccess: '导出成功',
    exportFailed: '导出失败',
    resolveFailed: '解析依赖失败',
    bundleExportLabel: '联合导出（包含成员、技能、MCP 服务器）',
    bundleExportHint: '勾选后将导出完整依赖包（ZIP），包含关联的成员、技能文件和 MCP 服务器配置',
    importDropHint: '将 JSON 或 ZIP 文件拖拽到此处，或点击选择文件',
    importSelectFile: '选择文件',
    importInvalidFile: '无效的导入文件，请选择正确的 JSON 或 ZIP 文件',
    importPreviewFailed: '导入预览失败',
    importPreviewSummary: '检测到以下资源：',
    importConflict: '已存在',
    importConflictStrategy: '冲突处理策略',
    importStrategySkip: '跳过已存在的资源',
    importStrategyOverwrite: '覆盖已存在的资源',
    importStrategyCopy: '创建副本',
    importConfirm: '确认导入',
    importSuccess: '导入成功',
    importFailed: '导入失败',
  ...
  mcpServer: {
    ...
    importInvalidFile: '无效的导入文件，请选择正确的 JSON 文件',
    importPreviewFailed: '导入预览失败',
    importPreviewSummary: '共检测到 {count} 个 MCP 服务器',
    importConflict: '已存在',
    importConflictStrategy: '冲突处理策略',
    importStrategySkip: '跳过已存在的服务器',
    importStrategyOverwrite: '覆盖已存在的服务器',
    importStrategyCopy: '创建副本',
    importConfirm: '确认导入',
    importBack: '上一步',
    importSuccess: 'MCP 服务器已导入',
    importFailed: '导入 MCP 服务器失败',
    importResultSuccess: '成功导入 {count} 个服务器',
    importResultSkipped: '跳过 {count} 个服务器',
    serverTypeLabel: '类型',
  },
  iteration: {
    title: '迭代',
  ...
  team: {
    ...
    deleteConfirmMessage: '确定要删除 "{name}" 吗？该项目关联不会被删除。',
    loadFailed: '加载团队失败',
    teamWorkspaceTitle: '团队工作空间',
    teamWorkspaceDescription: '将多个项目组织为团队，跨项目协作和任务管理',
    teamCountSuffix: '个团队',
    emptyTeamTitle: '还没有团队',
    createFirstTeam: '创建第一个团队',
    repoCount: '个项目',
    openTeam: '打开团队',
    knowledgeBadge: '知识仓库',
    developmentBadge: '开发仓库',
    internalRepos: '内部仓库',
    addProject: '添加项目',
    addProjectToTeam: '添加项目到团队',
    removeProject: '移除',
    noProjectsInTeam: '此团队暂无项目',
    crossRepoKanban: '跨项目任务看板',
    repoRole: '仓库角色',
    projectAdded: '项目已添加到团队',
    addProjectFailed: '添加项目到团队失败',
    projectRemoved: '项目已从团队移除',
    removeProjectFailed: '移除项目失败',
    kanbanHint: '跨项目任务看板已集成到 Agent 指挥中心，选择团队即可查看聚合看板',
    goToWorkspace: '前往 Agent 指挥中心',
    unassignedTitle: '未加入团队的项目',
  },
  agentKnowledgeBus: {
    title: 'Agent 知识总线',
    description: '按团队聚合所有项目的文件结构，一站式浏览与阅读',
    sidebarTitle: '项目',
    selectProjectHint: '请从左侧选择一个项目以查看文件树',
    selectFileHint: '请在文件树中选择一个文件进行预览',
    noTeams: '暂无团队，请先在工作空间创建团队',
    noArchitectureDoc: '未找到 ARCHITECTURE.md 或 README.md',
    emptyRepo: '此项目暂无文件或未配置本地路径',
    binaryFile: '二进制文件，不支持预览',
    toc: '目录',
    edit: '编辑',
    saving: '保存中...',
    unsaved: '未保存',
