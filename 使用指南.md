...
![项目首页](screenshots/01-project-home.png)
...
![项目看板](screenshots/02-kanban-board.png)
...
![Agent 配置](screenshots/03-agent-config.png)
...
![Workflow 模板配置](screenshots/04-workflow-template.png)
...
![Workflow 执行](screenshots/05-workflow-execution.png)
...
![技能管理](screenshots/06-skills-config.png)
...
![MCP 服务器配置](screenshots/07-mcp-config.png)
